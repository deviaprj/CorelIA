...
**Verdict** : **Rejete pour mobile** — modele trop lourd, complexite d'integration elevee. Option interessante pour un backend cloud dédié à la synthèse vocale (`api.zentic.fr/tts`).
